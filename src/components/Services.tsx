  ...
  const services = [
    {
      ...
      description: "Building scalable web applications using modern technologies like React, Node.js, and Spring Boot.",
      icon: "💻",
    ...
    },
    {
      ...
      description: "Designing and implementing robust RESTful APIs and microservices architecture.",
      icon: "🔌",
      image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
    },
    {
      title: "Cloud Solutions",
      description: "Implementing cloud-based solutions using AWS services for scalable and reliable applications.",
      icon: "☁️",
    ...
    {
      title: "DevOps & CI/CD",
      description: "Setting up automated deployment pipelines and implementing DevOps best practices.",
      icon: "🔄",
